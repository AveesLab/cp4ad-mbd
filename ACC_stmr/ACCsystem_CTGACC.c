...
real_T ACCsystem_CTGACC(real_T rtu_LongitudinalVelocity, real_T
  rtu_RelativeDistance, real_T rtu_RelativeVelocity, B_CTGACC_ACCsystem_T
  *localB)
{
   ...
   *  Sum: '<S1>/Sum4'
   */
  return fmin((30.0 - rtu_LongitudinalVelocity) * 5.0, 2.0 *
